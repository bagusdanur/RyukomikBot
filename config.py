...
PROJECT_PUBLIC_URL = os.getenv("PROJECT_PUBLIC_URL", "https://ryukomik.web.id").rstrip("/")
PROJECT_EVENTS_URL = os.getenv("PROJECT_EVENTS_URL", "https://www.ryukomik.web.id/api/internal/project-discord-events")

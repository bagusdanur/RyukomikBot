...
SOURCE_ORDER = ("asura", "omega", "doujiva", "diva", "evascan", "thunder", "vortex", "qimanga", "demon", "kagane", "mgeko", "dusk", "lagoon", "ken", "mgread", "mangadex")
...
async def resolve_assignment_raw(title, allowed_chapters, downloaders, progress=None, timeout=12):
    ...
    async def run():
        ...
        await report("Mencari judul di seluruh sumber RAW secara bersamaan...")

...
<template>
  ...
  <main v-else-if="!user" class="login-page">
    <section class="login-card">
      <img class="brand-mark" src="/icons/ryukomik-web-20260804.png" alt="Logo Ryukomik" />
  ...
  <div v-else class="app-shell app-dark">
    <aside class="sidebar">
      <div class="brand">
        <img class="brand-mark small" src="/icons/ryukomik-web-20260804.png" alt="Logo Ryukomik" />

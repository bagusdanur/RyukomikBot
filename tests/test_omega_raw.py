...
class ThreeSourceResolverTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_equal_coverage_uses_business_priority(self):
        self.assertEqual(SOURCE_ORDER, ("asura", "omega", "doujiva", "diva", "evascan", "thunder", "vortex", "qimanga", "demon", "kagane", "mgeko"))
        downloaders = {
        ...
        self.assertEqual(
            ...
            ["omega", "doujiva", "diva", "evascan", "thunder", "vortex", "qimanga", "demon", "kagane", "mgeko"],
        )
